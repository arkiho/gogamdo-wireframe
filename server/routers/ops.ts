  ...
  expense: router({
    ...
    create: staffProcedure
      .input(z.object({
        ...
        expenseType: z.enum(["tax_invoice", "withholding", "withholding_expense", "daily_worker"]).optional(),
        taxDetail: z.record(z.string(), z.number()).optional(),
        paymentSchedule: z.array(z.object({
          kind: z.enum(["contract", "interim", "balance"]),
          amount: z.number(),
          dueDate: z.string().optional(),
          status: z.enum(["scheduled", "billed", "paid"]),
        })).optional(),
        scheduleItemId: z.number().optional(),
    ...
    update: staffProcedure
      .input(z.object({
        ...
        scheduleItemId: z.number().nullable().optional(),
        paymentMethod: z.enum(["bank_transfer", "card", "cash", "check"]).optional(),
        payeeName: z.string().optional(),
        payeeBank: z.string().optional(),
        payeeAccount: z.string().optional(),
