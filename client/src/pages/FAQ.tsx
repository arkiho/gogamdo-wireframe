...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "산업시설은 용도·규모에 따라 요구되는 인허가와 안전 기준이 다릅니다. 고감도는 설계 단계에서 관련 법규와 소방·전기·구조 기준을 검토하고, 필요한 인허가 절차를 안내·협조합니다. 시공 중에는 안전 관리 계획에 따라 현장을 통제하며, 자체 실시간 관리 시스템으로 공정·안전 사항을 공유합니다.",
  },
  ...
  // 서비스/프로세스 추가
  {
    ...
    answer: "네, 전국 프로젝트를 진행합니다. 실제로 경기·충청·경남 등 수도권 외 지역은 물론 해외 프로젝트(중국 등) 실적도 보유하고 있습니다. 지방 현장은 실측·설계 단계부터 방문 일정을 효율적으로 조율하고, 시공 중에는 실시간 공정 관리와 현장 카메라로 거리에 관계없이 진행 상황을 공유합니다.",
  },
  {
    category: "서비스",
