...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "고감도 홈페이지의 AI 견적 시스템에서 공간 유형, 면적, 원하는 등급을 입력하면 30초 만에 예상 비용을 확인할 수 있습니다. 더 정확한 견적이 필요하시면 무료 현장 실측 후 상세 견적서를 제공해 드립니다. 전화(02-xxxx-xxxx) 또는 온라인 상담 신청으로 예약 가능합니다.",
  },
  {
    category: "비용",
  ...
  // 서비스 관련
  {
    ...
    answer: "고감도는 사무실 인테리어 전문 기업으로, 공간 설계, 3D 시뮬레이션, 시공 관리, 가구 및 집기 조달, A/S까지 원스톱 서비스를 제공합니다. 사무실, 상업공간, 공유오피스, 쇼룸 등 다양한 업무 공간을 전문적으로 시공하며, 12년간 150건 이상의 프로젝트를 성공적으로 완료했습니다.",
  },
  {
    category: "서비스",
  ...
  // AI 기능 관련
  {
    ...
    answer: "고감도의 AI 견적 시스템은 12년간 150건 이상의 실제 프로젝트 데이터와 70개 이상의 거래처 단가 정보를 기반으로 예상 비용을 산출합니다. 정확도는 약 85~90% 수준이며, 정확한 견적은 현장 실측 후 제공됩니다. AI 견적은 예산 계획 수립에 참고용으로 활용하시기 좋습니다.",
  },
  {
    category: "AI 서비스",
