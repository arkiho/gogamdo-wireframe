  ...
  seoul: {
    ...
    why: [
      ...
      },
      {
        ...
        desc:
          "도심 오피스는 주말·야간 반입 규정과 소음 제약이 까다롭습니다. 자체 실시간 관리 시스템으로 공정과 현장 카메라를 공유하며 업무 중단을 최소화합니다.",
      },
      {
        title: "빠른 현장 대응",
        desc:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "가능합니다. 구간별 공사, 주말·야간 작업, 가벽 분리 등으로 업무 중단을 최소화합니다. 자체 시스템으로 진행 상황을 실시간 공유해 원격에서도 현장을 확인할 수 있습니다.",
      },
      {
        q: "서울 어느 지역까지 시공하나요?",
  ...
  yeouido: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "가능합니다. 구간 분리 시공과 주말·야간 작업으로 업무 연속성을 확보하며, 자체 시스템으로 진행 상황을 실시간 공유합니다.",
      },
    ],
